(function (ace, $, window, document, undefined) {
    ...
    var buttonActions = {
        ...
        raw: function () {
            if (document.location.pathname !== '/') {
                ...
                updateStatus('Save your code first');
            }
        },
        settings: function () {
    ...
    (function checkCookies() {
        ...
        if (cookiearray.length > 1) {
            ...
            var expr = ' expires=08 Aug 2020 00:00:01 GMT; path=/';
            [
                'lineselect=false;',
                'showinvisible=false;',
                'indentguides=true;',
    ...
    function setCookie(cookieName, value) {
        ...
        if (Object.keys(cookies).indexOf(cookieName) > -1) {
            document.cookie = cookieName + '=; expires=Fri, 10 Apr 1992 00:00:01 GMT; path=/';
        }
        if (cookieName !== 'theme') {
    ...
    function pushToState(data, name, id, url) {
        docid.val(id);
        window.history.pushState(data, name + '|| Ghost', url);
    }
